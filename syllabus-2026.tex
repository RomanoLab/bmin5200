...
\textbf{Late work receives a zero.} Assignment answers are reviewed in class once the deadline
has passed, which makes it impossible to accept a submission after the fact --- the answers are
public at that point. There is no partial-credit sliding scale and no grace period. If something
...
A one-page proposal is due \textbf{October 22, 2026, 11:59pm}, and is worth 5\% of the final
