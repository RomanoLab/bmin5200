...
\begin{tabular}{@{}llll@{}}
  ...
  \midrule
  Homework 1 & Logic & Sep 3 & Wed Sep 23, 11:59pm \\
  Homework 2 & Semantic networks \& search & Sep 17 & Wed Oct 7, 11:59pm \\
  Homework 3 & Expert system in CLIPS & Oct 22 & Wed Nov 4, 11:59pm \\
  Homework 4 & Bayesian networks & Oct 29 & Wed Nov 18, 11:59pm \\
  \bottomrule
\end{tabular}
...
it costs to prepare. Discussion credit is for the other nine weeks --- everyone reads the paper,
...
A one-page proposal is due \textbf{Wednesday, October 28, 2026, 11:59pm}, and is worth 5\% of the final
...
\begin{longtable}{@{}cl>{\raggedright\arraybackslash}p{5.1cm}>{\raggedright\arraybackslash}p{3.3cm}l@{}}
  ...
  3 & Sep 10 & Semantic networks, frames, ontologies & McCarthy & \\
  4 & Sep 17 & Heuristic, local \& population-based search & Ashburner et al. & \\
  --- & Sep 24 & \emph{No class --- instructor away} & & \textbf{HW 1} \\
  --- & Oct 1 & \emph{No class --- Fall Break} & & \\
  5 & Oct 8 & Biologically-inspired search & Wolpert \& Macready & \textbf{HW 2} \\
  6 & Oct 15 & Rules \& knowledge-based systems & Kennedy \& Eberhart & \\
  7 & Oct 22 & Building an expert system: CLIPS / clipspy & Shortliffe et al. & \\
  8 & Oct 29 & Bayesian networks; state machines & Miller et al. & \textbf{Project proposal} \\
  9 & Nov 5 & Information theory \& machine learning & de Dombal et al. & \textbf{HW 3} \\
  10 & Nov 12 & Deep learning \& large language models & Quinlan & \\
  11 & Nov 19 & Explainable AI & Vaswani et al. & \textbf{HW 4} \\
  --- & Nov 26 & \emph{No class --- Thanksgiving} & & \\
  12 & Dec 3 & Bias \& fairness in AI & Caruana et al. & \\
